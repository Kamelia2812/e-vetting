...
<body> 
    <div class="card">
        ...
        <h1>UMT E-Vetting System</h1>
        <p>Log in to access the assessment vetting platform</p>

        <form method="post" action="${pageContext.request.contextPath}/LoginServlet">
            <label>Email</label>
            <input type="email" name="email" placeholder="s73073.email@umt.edu.my" required/>
